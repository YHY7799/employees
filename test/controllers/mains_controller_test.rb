...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { allowance: @main.allowance, comment: @main.comment, month: @main.month, name: @main.name, salary: @main.salary, year: @main.year } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { allowance: @main.allowance, comment: @main.comment, month: @main.month, name: @main.name, salary: @main.salary, year: @main.year } }
